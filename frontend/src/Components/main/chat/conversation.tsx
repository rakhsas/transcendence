...
const ConversationArea: React.FC<data> = ({ latestMessages, selectedMessageIndex, lstGroupMessages, handleSelectMessage, setLstGroupMessages, userData, isOpen, setIsOpen, selectedItem, setSelectedItem, socket }) => {
	...
	return (
		<div className={`sm:flex flex-col bg-red-600 w-full sm:w-auto ${selectedMessageIndex ? 'hidden' : '' } relative justify-between pb-5 overflow-y-auto w-64 overflow-x-hidden border-r-[1px] dark:border-gray-700 border-black`}>
