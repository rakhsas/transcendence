        ...
        <>
            <div className="flex w-full border-t-[1px] dark:border-gray-700 border-black">
                ...
                </div>
                {
                    ...
                    ?
                        DetailsArea({ MESSAGES, selectedMessageIndex, handleSelectedColor, selectedColor, modalPicPath, isModalOpen, onCloseModal, onOpenModal, getMessageFriend, handleOpenDetails })
                        :
                        null
                    }
                {
