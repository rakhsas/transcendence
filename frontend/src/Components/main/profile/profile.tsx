...
function FunctionProfileForm() {
    ...
    return (
        <div className="
            ...
            Setting"
        >
            <div className="Acheivementpart flex flex-col  items-center  gap-4 w-full md:min-w-[35%] overflow-y-scroll no-scrollbar min-h-full overflow-hidden Usredit--Achievements ">


                <div className="w-full flex justify-center mt-4 items-center max-w-sm bg-black h-[25vh] border-gray-200 overflow-y-scroll no-scrollbar rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
                    ...
                    <div className="flex flex-col items-center  p-10 overflow-hidden overflow-y-scroll no-scrollbar mt-3">
                        <img className="w-24 h-auto  shadow-lg picture-user" src={user?.picture || picture} alt="Bonnie image" />
                        <h5 className=" text-xl h-[35px] overflow-hidden text-white-900 dark:text-white font-bolder picture-user2">{user?.username}</h5>
                        <div className="flex gap-1 mt-2">
                            ...
                            <a href="#" onClick={ButtonClick} className="inline-flex items-center px-4 py-2 text-sm h-auto overflow-hidden text-center text-black-950 font-bolder
                             bg-red-600 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                ...
                <div className='w-[90%] flex flex-col gap-1 items-center h-[75vh] justify-center Achieve--Border bg-black overflow-y-scroll no-scrollbar '>
                    <h5 className='font-bolder text-gray-800 l5 '>ACHIEVEMENTS</h5>
                    <div className='Valid--Achievement flex flex-row  justify-center items-center overflow-y-scroll no-scrollbar '>
                    ...
                    <div className='Valid--Achievement flex flex-row  justify-center items-center'>
                        <img src={Achei6} alt="" className='ml-2 w-[80px] h-[45px]' />
                        <p className='flex flex-row justify-center items-center Center--paragraph'>Play The First Game</p>
                        <svg className="w-6  text-gray-800 dark:text-white svgIcon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                            <path fillRule="evenodd" d="M12 2a3 3 0 0 0-2.1.9l-.9.9a1 1 0 0 1-.7.3H7a3 3 0 0 0-3 3v1.2c0 .3 0 .5-.2.7l-1 .9a3 3 0 0 0 0 4.2l1 .9c.2.2.3.4.3.7V17a3 3 0 0 0 3 3h1.2c.3 0 .5 0 .7.2l.9 1a3 3 0 0 0 4.2 0l.9-1c.2-.2.4-.3.7-.3H17a3 3 0 0 0 3-3v-1.2c0-.3 0-.5.2-.7l1-.9a3 3 0 0 0 0-4.2l-1-.9a1 1 0 0 1-.3-.7V7a3 3 0 0 0-3-3h-1.2a1 1 0 0 1-.7-.2l-.9-1A3 3 0 0 0 12 2Zm3.7 7.7a1 1 0 1 0-1.4-1.4L10 12.6l-1.3-1.3a1 1 0 0 0-1.4 1.4l2 2c.4.4 1 .4 1.4 0l5-5Z" clipRule="evenodd" />
                        </svg>
                    </div>
            ...
            <div className="ScorePart flex flex-col   gap-4 w-full md:min-w-[65%] min-h-full overflow-hidden no-scrollbar overflow-y-scroll Information justify-center items-center ">


                <div className="w-[50vw] flex flex-col justify-center items-center mt-4   gap-1  bg-black h-[55vh] border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 overflow-hidden no-scrollbar overflow-y-scroll">
                    <h5 className='font-bolder text-gray-800 l5 '>SCORE-MATCHES</h5>
                    
                    <div className='Score--Match flex gap-8 flex-row justify-center items-center mt-4 overflow-hidden no-scrollbar overflow-y-scroll'>
                        <img
                            src={userData?.picture || picture} alt="" className='picture--User'
                            style={{ border: `2px solid ${userData?.coalitionColor} ` }} />

                        <div className='chi overflow-y-scroll no-scrollbar flex flex-row gap-2'>
                ...
                <div className="w-[75%] flex flex-col mt-4 justify-center items-center  bg-black h-[25vh] border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">


                    <h5 className='font-bolder text-gray-800 l5 '>PROGRESS-USER</h5>
                    <div className='flex flex-row justify-center items-center gap-4 mr-8 overflow-hidden no-scrollbar overflow-y-scroll'>
