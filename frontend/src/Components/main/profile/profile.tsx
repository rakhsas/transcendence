    ...
    return (
        ...
        >
            <div className="Acheivementpart flex flex-col  items-center  gap-4 w-full md:min-w-[35%]  no-scrollbar min-h-full overflow-hidden Usredit--Achievements ">
                ...
                <div className="w-[85%] update flex justify-center mt-4 items-center   h-[25vh] dark:bg-zinc-900 bg-[#F1F2FD] border-gray-200  no-scrollbar rounded-lg shadow  overflow-hidden">
                    ...
                    <div className="flex flex-col items-center  p-10 overflow-hidden  no-scrollbar mt-3">
                        <img className="w-24 h-auto  shadow-lg picture-user" src={userData[0]?.picture || picture} alt="Bonnie image" style={{ border: `2px solid ${userData[0]?.coalitionColor} ` }} />
