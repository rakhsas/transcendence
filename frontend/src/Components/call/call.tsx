...
function call() {
    ...
    useEffect(() => {
        const socketInstance = io("https://192.168.8.100", {
            path: '/chat',
        });
        ...
        <div className="w-screen flex flex-col items-center bg-gray-600">
            <div className="p-4">
                ...
                <div className="flex flex-row justify-around">
                    <button id="call" className="cursor-pointer p-4 bg-green-400 rounded-xl" onClick={handleClick}>
                        Call
                    </button>
                    <button id="end" className="cursor-pointer p-4 bg-red-600 rounded-xl">
                        END Call
                    </button>
                </div>
            </div>
